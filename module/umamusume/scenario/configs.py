...
class MantConfig:
    ...
    def __init__(self, config: dict):
        ...
        self.mega_small_threshold = config.get("mega_small_threshold", 40)
        self.mega_medium_threshold = config.get("mega_medium_threshold", 50)
        self.mega_large_threshold = config.get("mega_large_threshold", 60)
        ...
        self.skip_race_percentile = config.get("skip_race_percentile", 81)
